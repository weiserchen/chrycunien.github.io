        ...
        <Grid item xs={12} lg={6} className="homeIntro">
          ...
          <animated.div style={animatedTexts[1]}>
            <Typography variant="body1">
              <Translate>
                A National Taiwan University undergraduate who has a great passion for system
                development. While keeping updated with the most recent
                technologies, I always seek to improve and grow as a
                professional system engineer as well as a good person.
              </Translate>{" "}
            </Typography>
          </animated.div>
          &nbsp;
          <animated.div style={animatedTexts[2]}>
            ...
            <Typography variant="body1" gutterBottom>
              Go, Java, Python, C/C++, HTML/CSS/JS, SQL, Shell Script, Git, Docker, Kubernetes, etc. 
            </Typography>
          </animated.div>
          &nbsp;
  ...
  return (
    <animated.div className="social__links" style={animatedProps}>
      <Grid container spacing={2}>
        ...
        <Grid item>
          <a href="https://github.com/woodcutter-eric">
            <FontAwesomeIcon icon={faGithub} />
          </a>
        </Grid>
        <Grid item>
          <a href="https://www.facebook.com/chenyingchiao/">
